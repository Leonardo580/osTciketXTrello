...
class StaffNav {
    ...
    function getTabs(){
        ...
        if(!isset($this->tabs)) {
            ...
            // add new tabs in nav bar
            $this->tabs['Repositories']=array('desc'=> __("Repositories"), 'href'=> "Repositories.php", "title"=> __("Repositories"));
            ...
            switch(strtolower($k)){
                ...
                case 'kbase':
                   ...
                   break;
                    //repo sub menu
                case "Repositories":
                    $subnav[]=array('desc'=> __("Add"), "href"=> "/", "iconclass"=> null);
                case 'apps':
